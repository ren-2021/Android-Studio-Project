...
public class PDF1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pdf1_acitivty);
        vpPager = (ViewPager)findViewById(R.id.pdf1);
        pdf1Adapter = new PDF1Adapter(getSupportFragmentManager());
        vpPager.setAdapter(pdf1Adapter);
