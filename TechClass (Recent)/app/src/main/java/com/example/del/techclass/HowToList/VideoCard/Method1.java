...
public class Method1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpPager = (ViewPager)findViewById(R.id.methodpager1);
        method1Adapter = new Method1Adapter(getSupportFragmentManager());
        vpPager.setAdapter(method1Adapter);
