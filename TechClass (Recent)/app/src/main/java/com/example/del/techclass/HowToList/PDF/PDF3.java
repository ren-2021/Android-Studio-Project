...
public class PDF3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pdf3_activity);
        vpPager = (ViewPager)findViewById(R.id.pdf3);
        pdf3Adapter = new PDF3Adapter(getSupportFragmentManager());
        vpPager.setAdapter(pdf3Adapter);
