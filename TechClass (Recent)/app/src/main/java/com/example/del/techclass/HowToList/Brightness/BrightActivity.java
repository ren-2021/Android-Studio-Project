...
public class BrightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpPager = (ViewPager)findViewById(R.id.brightpager);
        brightAdapter = new BrightAdapter(getSupportFragmentManager());
        vpPager.setAdapter(brightAdapter);
