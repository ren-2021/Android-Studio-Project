...
public class FormatComputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.format_computer);

        vpPager = (ViewPager) findViewById(R.id.formatPager);

        adapter = new FormatAdapter(getSupportFragmentManager());
