...
public class VirtualDesktopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.virtualdesktop_activity);

        vpPager = (ViewPager) findViewById(R.id.virtualpager);
        adapter = new VirtualDesktopAdapter(getSupportFragmentManager());
