...
public class BiosMenu extends AppCompatActivity {
    ViewPager vpPager;
    BiosMenuAdapter biosMenuAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.biosmenu_activity);
        vpPager = (ViewPager)findViewById(R.id.menupager);
        biosMenuAdapter = new BiosMenuAdapter(getSupportFragmentManager());
        vpPager.setAdapter(biosMenuAdapter);
