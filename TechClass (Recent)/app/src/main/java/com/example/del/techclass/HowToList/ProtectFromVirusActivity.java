...
public class ProtectFromVirusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.protect_from_virus);
        vpPager = (ViewPager)findViewById(R.id.protectpager);
        protectAdapter = new ProtectAdapter(getSupportFragmentManager());
        vpPager.setAdapter(protectAdapter);
