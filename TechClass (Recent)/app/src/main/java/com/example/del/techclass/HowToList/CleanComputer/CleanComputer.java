...
public class CleanComputer extends AppCompatActivity {
    ViewPager vpPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clean_computer);
        vpPager = (ViewPager)findViewById(R.id.cleanpager);
        cleanAdapter = new CleanAdapter(getSupportFragmentManager());
        vpPager.setAdapter(cleanAdapter);
