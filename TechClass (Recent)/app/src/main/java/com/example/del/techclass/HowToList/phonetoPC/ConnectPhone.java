...
public class ConnectPhone extends AppCompatActivity {
    ViewPager vpPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpPager = (ViewPager)findViewById(R.id.connectphone);
        connectAdapter = new ConnectAdapter(getSupportFragmentManager());
        vpPager.setAdapter(connectAdapter);
