...
public class UsbDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.usbdevice_activity);
        vpPager = (ViewPager)findViewById(R.id.usbpager);
        usbAdapter = new UsbAdapter(getSupportFragmentManager());
        vpPager.setAdapter(usbAdapter);
