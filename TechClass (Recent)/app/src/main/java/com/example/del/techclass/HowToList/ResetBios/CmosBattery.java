...
public class CmosBattery extends AppCompatActivity {
    ViewPager vpPager;
    CmosBatteryAdapter cmosBatteryAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cmos_battery);
        vpPager = (ViewPager)findViewById(R.id.cmos);
        cmosBatteryAdapter = new CmosBatteryAdapter(getSupportFragmentManager());
        vpPager.setAdapter(cmosBatteryAdapter);
