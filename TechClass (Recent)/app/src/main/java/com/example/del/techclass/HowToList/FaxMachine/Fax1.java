...
public class Fax1 extends AppCompatActivity {

    ViewPager vpPager;
    Fax1Adapter fax1Adapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fax1_activity);
        vpPager = (ViewPager)findViewById(R.id.fax1);
        fax1Adapter = new Fax1Adapter(getSupportFragmentManager());
        vpPager.setAdapter(fax1Adapter);
