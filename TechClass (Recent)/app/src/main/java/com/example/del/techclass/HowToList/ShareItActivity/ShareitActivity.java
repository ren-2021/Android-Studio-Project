...
public class ShareitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shareit_activity);
        vpPager = (ViewPager)findViewById(R.id.shareitpager);
        shareitAdapter = new ShareitAdapter(getSupportFragmentManager());
        vpPager.setAdapter(shareitAdapter);
