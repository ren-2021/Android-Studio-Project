...
public class DaisyChainActivity extends AppCompatActivity {
    ViewPager vpPager;
    DaisyChainAdapter daisyChainAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daisychain_activity);
        vpPager = (ViewPager)findViewById(R.id.daisychain);
        daisyChainAdapter = new DaisyChainAdapter(getSupportFragmentManager());
        vpPager.setAdapter(daisyChainAdapter);
