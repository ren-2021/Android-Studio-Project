...
public class PDF2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pdf2_activity);
        vpPager = (ViewPager)findViewById(R.id.pdf2);
        pdf2Adapter = new PDF2Adapter(getSupportFragmentManager());
        vpPager.setAdapter(pdf2Adapter);
