...
public class FixKeyboard extends AppCompatActivity {
    ViewPager vpPager;
    FixKeyboardAdapter fixKeyboardAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fix_keyboard);
        vpPager = (ViewPager)findViewById(R.id.fixpager);
        fixKeyboardAdapter = new FixKeyboardAdapter(getSupportFragmentManager());
        vpPager.setAdapter(fixKeyboardAdapter);
