...
public class DualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dual_activity);
        vpPager = (ViewPager)findViewById(R.id.dualpager);
        dualAdapter = new DualAdapter(getSupportFragmentManager());
        vpPager.setAdapter(dualAdapter);
