...
public class BiosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpPager = (ViewPager)findViewById(R.id.biospager);
        biosAdapter = new BiosAdapter(getSupportFragmentManager());
        vpPager.setAdapter(biosAdapter);
