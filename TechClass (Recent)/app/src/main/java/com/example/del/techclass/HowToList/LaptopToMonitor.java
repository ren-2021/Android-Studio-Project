...
public class LaptopToMonitor extends AppCompatActivity {

    ViewPager vpPager;
    LaptopToAdapter laptopToAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.laptoptomonitor);
        vpPager = (ViewPager)findViewById(R.id.laptoppager);
        laptopToAdapter = new LaptopToAdapter(getSupportFragmentManager());
        vpPager.setAdapter(laptopToAdapter);
