...
public class Method2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpPager = (ViewPager)findViewById(R.id.method2);
        method2Adapter = new Method2Adapter(getSupportFragmentManager());
        vpPager.setAdapter(method2Adapter);
