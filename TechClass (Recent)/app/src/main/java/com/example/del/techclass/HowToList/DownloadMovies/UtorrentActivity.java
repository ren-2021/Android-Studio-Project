...
public class UtorrentActivity extends AppCompatActivity {
    ViewPager vpPager;
    UtorrentAdapter utorrentAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.utorrent_activity);
        vpPager = (ViewPager)findViewById(R.id.torrentpager);
        utorrentAdapter = new UtorrentAdapter(getSupportFragmentManager());
        vpPager.setAdapter(utorrentAdapter);
