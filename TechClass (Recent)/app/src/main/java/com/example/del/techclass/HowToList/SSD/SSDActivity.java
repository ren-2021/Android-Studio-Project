...
public class SSDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ssd_activity);
        vpPager = (ViewPager)findViewById(R.id.ssdpager);
        ssDadapter = new SSDadapter(getSupportFragmentManager());
        vpPager.setAdapter(ssDadapter);
