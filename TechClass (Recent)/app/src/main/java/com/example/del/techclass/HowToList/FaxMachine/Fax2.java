...
public class Fax2 extends AppCompatActivity {

    Fax2Adapater fax2Adapater;
    ViewPager vpPager;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fax2_activity);
        vpPager = (ViewPager)findViewById(R.id.fax2);
        fax2Adapater = new Fax2Adapater(getSupportFragmentManager());
        vpPager.setAdapter(fax2Adapater);
