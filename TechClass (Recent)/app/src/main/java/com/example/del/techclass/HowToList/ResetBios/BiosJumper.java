...
public class BiosJumper extends AppCompatActivity {
    ViewPager vpPager;
    BiosJumperAdapter biosJumperAdapter;
    ImageView imageView;
    TextView prev, next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bios_jumper);
        vpPager = (ViewPager)findViewById(R.id.jumper);
        biosJumperAdapter = new BiosJumperAdapter(getSupportFragmentManager());
        vpPager.setAdapter(biosJumperAdapter);
